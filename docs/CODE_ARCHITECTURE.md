...
- `screenshot/get_window_id.py`: ScreenCaptureKit integration for window listing and filtering by app/title.
...
- Window selection options are translated to ScreenCaptureKit shareable-content query flags.
- Matching window ids are generated from ScreenCaptureKit metadata.
